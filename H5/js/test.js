!function(e) {
    ...
    (function() {
        ...
        return e.prototype.getSong = function() {
            var e = this;
            $.get(this.fmUrl + "getSong.php", {
                channel: "public_shiguang_80hou"
            }, function(t) {
                if (null === t.song[0].url && null === t.song[0].artist && null === t.song[0].title)
                    this.getSong();
                else {
                    var n = "<h3>歌曲：" + t.song[0].title + " </h3><p>演唱者：" + t.song[0].artist + "</p><p> 来源：80后音乐榜单</p>";
                    e.audioEle.attr({
                        src: t.song[0].url,
                        autoplay: "true"
                    }),
                    e.albumBox.html(n),
                    e.truePic.attr("src", t.song[0].picture),
                    e.imgFilter.css("backgroundImage", "url(" + t.song[0].picture + ")"),
                    e.sid = t.song[0].sid,
                    e.audio.volume = "0.7",
                    e.getLyric()
                }
        ...
        ,
        e.prototype.getLyric = function() {
            var e = []
              , t = this;
            $.post(t.fmUrl + "getLyric.php", {
                sid: t.sid
            }, function(n) {
                var r = JSON.parse(n).lyric
                  , i = r.split("\n")
                  , o = /\[\d{2}:\d{2}.\d{2}\]/g;
                i.forEach(function(t) {
                    ...
                    var n = t.match(o)
                      , r = t.split(n)
                      , a = 600 * n[0][1] + 60 * n[0][2] + 10 * n[0][4] + 1 * n[0][5];
                    e.push([a, r[1]])
                }),
                t.readyLyric(e)
            })
        ...
        ,
        e.prototype.readyLyric = function(e) {
            this.lyricBox.empty();
            var t = 0
              , n = '<div class="lyric-ani" data-height="20">';
            e.forEach(function(e, r) {
                var i = void 0 === e[1] ? "^_^歌词错误^_^" : e[1];
                n += '<p class="lyric-line" data-id="' + r + '" data-time="' + e[0] + '">&nbsp;' + i + "&nbsp;</p>",
                t++
            }),
            n += "</div>",
            this.lyricBox.append(n),
            this.onTimeUpdate(t)
        }
        ,
        e.prototype.onTimeUpdate = function(e) {
            var t = this
              , n = $(".lyric-ani")
              , r = n.data("height")
              , i = t.lyricBox.find(".lyric-ani p")
              , o = (audio.currentTime,
            audio.duration);
            this.audioEle.on("timeupdate", function() {
                isNaN(o) && (o = audio.duration);
                for (var a = 0; a < e; a++) {
                    var s = i.eq(a).data("time")
                      , u = i.eq(a + 1).data("time")
                      , l = audio.currentTime;
                    l > u && (i.removeClass("active"),
                    n.css({
                        height: r * e + "px",
                        marginTop: -parseInt(r * a - 100) + "px",
                        transition: "6s"
                    })),
                    l > s && l < u && i.eq(a).addClass("active")
                }
                parseInt(o - 60 * parseInt(o / 60)) < 10 ? t.durationTime.text(parseInt(o / 60) + ":0" + parseInt(o - 60 * parseInt(o / 60))) : t.durationTime.text(parseInt(o / 60) + ":" + parseInt(o - 60 * parseInt(o / 60))),
                parseInt(l - 60 * parseInt(l / 60)) < 10 ? t.currentTime.text(parseInt(l / 60) + ":0" + parseInt(l - 60 * parseInt(l / 60))) : t.currentTime.text(parseInt(l / 60) + ":" + parseInt(l - 60 * parseInt(l / 60))),
                t.progressLine.css({
                    width: l / o * 100 + "%"
                }),
        ...
        ,
        e.prototype.volumeDrag = function() {
            var e = this;
            ...
            this.progress.on("mousemove click", function(t) {
                if (e.clicking || "click" === t.type) {
                    var n = $(this).width()
                      , r = t.pageX - $(this).offset().left
                      , i = r / n;
                    (i <= 1 || i >= 0) && (e.audio.currentTime = i * e.audio.duration,
                    e.progressLine.css("width", 100 * i + "%"),
                    e.audio.play(),
                    $(".play-btn").html("&#xe6ee;"))
                }
            })
        ...
        ,
        e.prototype.volumeBarLine = function() {
            var e = this;
            this.volumeBar.on("mousemove", function(t) {
                var n = $(this).width()
                  , r = t.pageX - $(this).offset().left
                  , i = r / n;
                r > 0 && r <= n && (e.volumeLine.css("width", 100 * i + "%"),
                e.audio.volume = i),
                i > .5 ? e.vol.html("&#xe63d") : i < .5 && i > .04 ? e.vol.html("&#xe63c") : e.vol.html("&#xe63b")
            })
        }
        ,
        e.prototype.showLyric = function() {
            var e = this;
            this.lyric.on("click", function() {
                $(this).data("type") ? ($(this).data("type", 0),
                e.bigBox.removeClass("active")) : ($(this).data("type", 1),
                e.bigBox.addClass("active"))
            })
        }
        ,
        e.prototype.nextMusic = function() {
            var e = this;
            this.next.on("click", function() {
                e.like.html("&#xe601;"),
                e.outType.data("type", 0).html("&#xe67c;"),
                e.audioEle.attr({
                    loop: !1
                }),
                e.play.html("&#xe6ee;"),
        ...
        e.prototype.playMusic = function() {
            ...
            this.play.on("click", function() {
                e.audio.paused ? (e.audio.play(),
                $(this).html("&#xe6ee;")) : (e.audio.pause(),
                $(this).html("&#xe602;"))
            })
        }
        ,
        e.prototype.checkLove = function() {
            this.like.on("click", function() {
                $(this).data("type") ? $(this).data("type", 0).html("&#xe601;") : $(this).data("type", 1).html("&#xe60a;")
            })
        }
        ,
        e.prototype.checkShare = function() {
            ...
            this.share.on("click", function() {
                var t = e.albumBox.text().replace(" ", "%0d%0a")
                  , n = e.truePic.attr("src");
                window.open("http://service.weibo.com/share/share.php?title=" + t + "%0d%0a龙柏龙的云音乐♪&url=" + window.location.href + "&pic=" + n)
            })
        }
        ,
        e.prototype.outMusicType = function() {
            var e = this;
            this.outType.on("click", function() {
                $(this).data("type") ? ($(this).data("type", 0).html("&#xe67c;"),
                e.audioEle.attr({
                    loop: !1
...
, function(e, t, n) {
    ...
    !function(t, n) {
        ...
        function l(e, t, n) {
            ...
            }) : je.test(t) ? ye.filter(t, e, n) : (t = ye.filter(t, e),
        ...
        function x(e, t, n, r) {
            ...
            , u = s(), l = n && n[3] || (ye.cssNumber[t] ? "" : "px"), c = (ye.cssNumber[t] || "px" !== l && +u) && _e.exec(ye.css(e, t));
            if (c && c[3] !== l) {
                l = l || c[3],
                n = n || [],
                c = +u || 1;
        ...
        function k(e, t, n, r, i) {
            for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
                if ((o = e[d]) || 0 === o)
                    if ("object" === ye.type(o))
                        ye.merge(p, o.nodeType ? [o] : o);
                    else if (Ke.test(o)) {
                        for (a = a || f.appendChild(t.createElement("div")),
                        s = (Ye.exec(o) || ["", ""])[1].toLowerCase(),
                        u = Je[s] || Je._default,
                        a.innerHTML = u[1] + ye.htmlPrefilter(o) + u[2],
                        c = u[0]; c--; )
                            a = a.lastChild;
        ...
        function $(e, t, n, r) {
            t = le.apply([], t);
            var i, o, s, u, l, c, f = 0, p = e.length, d = p - 1, h = t[0], g = ye.isFunction(h);
            if (g || p > 1 && "string" == typeof h && !ve.checkClone && ot.test(h))
            ...
            o || r)) {
                for (s = ye.map(T(i, "script"), A),
                u = s.length; f < p; f++)
                    l = i,
                    f !== d && (l = ye.clone(l, !0, !0),
                    u && ye.merge(s, T(l, "script"))),
                    n.call(e[f], l, f);
                if (u)
                    ...
                    f = 0; f < u; f++)
                        l = s[f],
                        Qe.test(l.type || "") && !Ie.access(l, "globalEval") && ye.contains(c, l) && (l.src ? ye._evalUrl && ye._evalUrl(l.src) : a(l.textContent.replace(st, ""), c))
            }
            return e
        }
        function F(e, t, n) {
            for (var r, i = t ? ye.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
                n || 1 !== r.nodeType || ye.cleanData(T(r)),
                r.parentNode && (n && ye.contains(r.ownerDocument, r) && C(T(r, "script")),
        ...
        function O(e, t, n) {
            ...
            !ve.pixelMarginRight() && lt.test(a) && ut.test(t) && (r = s.width,
            i = s.minWidth,
            o = s.maxWidth,
        ...
        function M(e) {
            var t = ye.cssProps[e];
            return t || (t = ye.cssProps[e] = I(e) || e),
            t
        }
        function R(e, t, n) {
            var r = _e.exec(t);
        ...
        function B(e, t, n, r, i) {
            ...
            for (o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2)
                "margin" === n && (a += ye.css(e, n + Ue[o], !0, i)),
                r ? ("content" === n && (a -= ye.css(e, "padding" + Ue[o], !0, i)),
                "margin" !== n && (a -= ye.css(e, "border" + Ue[o] + "Width", !0, i))) : (a += ye.css(e, "padding" + Ue[o], !0, i),
                "padding" !== n && (a += ye.css(e, "border" + Ue[o] + "Width", !0, i)));
            return a
        }
        function W(e, t, n) {
            var r, i = ct(e), o = O(e, t, i), a = "border-box" === ye.css(e, "boxSizing", !1, i);
            return lt.test(o) ? o : (r = a && (ve.boxSizingReliable() || o === e.style[t]),
            "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]),
            (o = parseFloat(o) || 0) + B(e, t, n || (a ? "border" : "content"), r, i) + "px")
        }
        function _(e, t, n, r, i) {
            return new _.prototype.init(e,t,n,r,i)
        }
        function U() {
            yt && (!1 === ae.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(U) : n.setTimeout(U, ye.fx.interval),
            ye.fx.tick())
        }
        function X() {
        ...
        function G(e, t, n) {
            var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && Xe(e), m = Ie.get(e, "fxshow");
            ...
            if ((u = !ye.isEmptyObject(t)) || !ye.isEmptyObject(d)) {
                ...
                l = m && m.display,
                null == l && (l = Ie.get(e, "display")),
                c = ye.css(e, "display"),
                "none" === c && (l ? c = l : (w([e], !0),
                l = e.style.display || l,
                c = ye.css(e, "display"),
                w([e]))),
                ("inline" === c || "inline-block" === c && null != l) && "none" === ye.css(e, "float") && (u || (p.done(function() {
                    h.display = l
                }),
                null == l && (c = h.display,
                l = "none" === c ? "" : c)),
                ...
                u = !1;
                for (r in d)
                    u || (m ? "hidden"in m && (g = m.hidden) : m = Ie.access(e, "fxshow", {
                        display: l
                    }),
                    o && (m.hidden = !g),
                    g && w([e], !0),
        ...
        function Q(e, t, n) {
            var r, i, o = 0, a = Q.prefilters.length, s = ye.Deferred().always(function() {
                ...
                if (i)
                    return !1;
                for (var t = vt || X(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; a < u; a++)
                    l.tweens[a].run(o);
        ...
        ye.extend({
            ...
            makeArray: function(e, t) {
                var n = t || [];
                return null != e && (s(Object(e)) ? ye.merge(n, "string" == typeof e ? [e] : e) : ce.call(n, e)),
                n
            },
        ...
        var Ce = function(e) {
            function t(e, t, n, r) {
                ...
                "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                    return n;
                if (!r && ((t ? t.ownerDocument || t : M) !== L && A(t),
                t = t || L,
                H)) {
                    if (11 !== h && (u = ge.exec(e)))
                        if (i = u[1]) {
            ...
            function y(e, n) {
                var i = n.length > 0
                  ...
                  , a = function(r, a, s, u, l) {
                    var c, f, p, d = 0, h = "0", m = r && [], v = [], y = N, x = r || o && w.find.TAG("*", l), b = R += null == y ? 1 : Math.random() || .1, T = x.length;
                    for (l && (N = a === L || a || l); h !== T && null != (c = x[h]); h++) {
                        if (o && c) {
                            for (f = 0,
                            a || c.ownerDocument === L || (A(c),
                            s = !H); p = e[f++]; )
                                if (p(c, a || L, s)) {
                                    u.push(c);
                                    break
            ...
            var x, b, w, T, C, k, E, S, N, j, D, A, L, q, H, $, F, O, P, I = "sizzle" + 1 * new Date, M = e.document, R = 0, B = 0, W = n(), _ = n(), U = n(), X = function(e, t) {
                return e === t && (D = !0),
                0
            ...
            A = t.setDocument = function(e) {
                ...
                (b.matchesSelector = he.test(O = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function(e) {
                    b.disconnectedMatch = O.call(e, "*"),
                    O.call(e, "[s!='']:x"),
                    F.push("!=", re)
                }),
                ...
                X = t ? function(e, t) {
                    ...
                    1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === M && P(M, e) ? -1 : t === L || t.ownerDocument === M && P(M, t) ? 1 : j ? K(j, e) - K(j, t) : 0 : 4 & n ? -1 : 1)
                }
                : function(e, t) {
                    if (e === t)
                        return D = !0,
                    ...
                    if (!i || !o)
                        return e === L ? -1 : t === L ? 1 : i ? -1 : o ? 1 : j ? K(j, e) - K(j, t) : 0;
                    if (i === o)
                        return a(e, t);
            ...
            t.matchesSelector = function(e, n) {
                ...
                n = n.replace(ue, "='$1']"),
                b.matchesSelector && H && !U[n + " "] && (!F || !F.test(n)) && (!$ || !$.test(n)))
                    try {
                        var r = O.call(e, n);
                    ...
                    CHILD: function(e, t, n, r, i) {
                        ...
                        : function(t, n, u) {
                            ...
                            if (m) {
                                ...
                                x = d),
                                !1 === x)
                                    for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && (f = p[I] || (p[I] = {}),
                                    c = f[p.uniqueID] || (f[p.uniqueID] = {}),
                                    c[e] = [R, x]),
                                    p !== t)); )
                                        ;
            ...
            S = t.select = function(e, t, n, r) {
                ...
                return (c || E(e, p))(r, t, !H, n, !t || me.test(e) && l(t.parentNode) || t),
                n
            }
            ,
        ...
        ye.each({
            ...
            ye.fn[e] = function(n, r) {
                ...
                this.length > 1 && (qe[e] || ye.uniqueSort(i),
                Le.test(e) && i.reverse()),
                this.pushStack(i)
            }
        });
                    ...
                    then: function(e, r, i) {
                        function o(e, t, r, i) {
                            return function() {
                                var s = this
                                  ...
                                  , l = function() {
                                    ...
                                    if (!(e < a)) {
                                        ...
                                        ye.isFunction(l) ? i ? l.call(n, o(a, t, p, i), o(a, t, d, i)) : (a++,
                                        l.call(n, o(a, t, p, i), o(a, t, d, i), o(a, t, p, t.notifyWith))) : (r !== p && (s = void 0,
                                        u = [n]),
                                        (i || t.resolveWith)(s, u))
                                    }
                                }
                                  , c = i ? l : function() {
                                    try {
                                        ...
                                        ye.Deferred.exceptionHook && ye.Deferred.exceptionHook(n, c.stackTrace),
                                        e + 1 >= a && (r !== d && (s = void 0,
                                        u = [n]),
                                        t.rejectWith(s, u))
                                    }
                                ...
                                ;
                                e ? c() : (ye.Deferred.getStackHook && (c.stackTrace = ye.Deferred.getStackHook()),
                                n.setTimeout(c))
                            }
                        }
                        var a = 0;
        ...
        ye.extend({
            ...
            ready: function(e) {
                ...
                !0 !== e && --ye.readyWait > 0 || Fe.resolveWith(ae, [ye]))
            }
        }),
        ...
        ye.extend({
            queue: function(e, t, n) {
                ...
                if (e)
                    return t = (t || "fx") + "queue",
                    r = Ie.get(e, t),
                    n && (!r || Array.isArray(n) ? r = Ie.access(e, t, ye.makeArray(n)) : r.push(n)),
                    r || []
            },
        ...
        ye.event = {
                ...
                if (m && (u = m.events)) {
                    ...
                    l = t.length; l--; )
                        ...
                        d) {
                            ...
                            a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || ye.removeEvent(e, d, m.handle),
                            delete u[d])
                        } else
                            for (d in u)
            ...
            dispatch: function(e) {
                var t, n, r, i, o, a, s = ye.event.fix(e), u = new Array(arguments.length), l = (Ie.get(this, "events") || {})[s.type] || [], c = ye.event.special[s.type] || {};
                for (u[0] = s,
                ...
                !c.preDispatch || !1 !== c.preDispatch.call(this, s)) {
                    ...
                    t = 0; (i = a[t++]) && !s.isPropagationStopped(); )
                        ...
                        n = 0; (o = i.handlers[n++]) && !s.isImmediatePropagationStopped(); )
                            ...
                            s.data = o.data,
                            void 0 !== (r = ((ye.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u)) && !1 === (s.result = r) && (s.preventDefault(),
                            s.stopPropagation()));
        ...
        ye.fn.extend({
            ...
            empty: function() {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType && (ye.cleanData(T(e, !1)),
                    e.textContent = "");
                return this
            },
            clone: function(e, t) {
                ...
                return Oe(this, function(e) {
                    ...
                    if ("string" == typeof e && !it.test(e) && !Je[(Ye.exec(e) || ["", ""])[1].toLowerCase()]) {
                        ...
                        try {
                            for (; n < r; n++)
                                t = this[n] || {},
                                1 === t.nodeType && (ye.cleanData(T(t, !1)),
                                t.innerHTML = e);
                            t = 0
                        } catch (e) {}
                    }
            ...
            replaceWith: function() {
                ...
                return $(this, arguments, function(t) {
                    ...
                    ye.inArray(this, e) < 0 && (ye.cleanData(T(this)),
        ...
        ye.each(["height", "width"], function(e, t) {
            ye.cssHooks[t] = {
                get: function(e, n, r) {
                    if (n)
                        return !ft.test(ye.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? W(e, t, r) : ze(e, dt, function() {
                            return W(e, t, r)
                        })
                },
                set: function(e, n, r) {
                    var i, o = r && ct(e), a = r && B(e, t, r, "border-box" === ye.css(e, "boxSizing", !1, o), o);
                    return a && (i = _e.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                    n = ye.css(e, t)),
                    R(e, n, a)
                }
            }
        ...
        ye.fn.extend({
            ...
            finish: function(e) {
                return !1 !== e && (e = e || "fx"),
                this.each(function() {
                    var t, n = Ie.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = ye.timers, a = r ? r.length : 0;
                    for (n.finish = !0,
                    ye.queue(this, e, []),
        ...
        ye.extend({
            attr: function(e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute ? ye.prop(e, t, n) : (1 === o && ye.isXMLDoc(e) || (i = ye.attrHooks[t.toLowerCase()] || (ye.expr.match.bool.test(t) ? wt : void 0)),
        ...
        ye.extend(ye.event, {
            trigger: function(e, t, r, i) {
                var o, a, s, u, l, c, f, p = [r || ae], d = he.call(e, "type") ? e.type : e, h = he.call(e, "namespace") ? e.namespace.split(".") : [];
                if (a = s = r = r || ae,
                3 !== r.nodeType && 8 !== r.nodeType && !St.test(d + ye.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."),
                d = h.shift(),
                h.sort()),
                l = d.indexOf(":") < 0 && "on" + d,
                ...
                i || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                    if (!i && !f.noBubble && !ye.isWindow(r)) {
                        ...
                        St.test(u + d) || (a = a.parentNode); a; a = a.parentNode)
                            p.push(a),
                            s = a;
                    ...
                    for (o = 0; (a = p[o++]) && !e.isPropagationStopped(); )
                        ...
                        c = (Ie.get(a, "events") || {})[e.type] && Ie.get(a, "handle"),
                        c && c.apply(a, t),
                        (c = l && a[l]) && c.apply && Pe(a) && (e.result = c.apply(a, t),
                        !1 === e.result && e.preventDefault());
                    return e.type = d,
                    i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), t) || !Pe(r) || l && ye.isFunction(r[d]) && !ye.isWindow(r) && (s = r[l],
                    s && (r[l] = null),
                    ye.event.triggered = d,
                    r[d](),
        ...
        ve.focusin || ye.each({
            ...
            ye.event.special[t] = {
                ...
                teardown: function() {
                    var r = this.ownerDocument || this
                      , i = Ie.access(r, t) - 1;
                    i ? Ie.access(r, t, i) : (r.removeEventListener(e, n, !0),
                    Ie.remove(r, t))
                }
            }
        });
        ...
        ye.fn.extend({
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var e = this.type;
                    return this.name && !ye(this).is(":disabled") && Ht.test(this.nodeName) && !qt.test(e) && (this.checked || !Ge.test(e))
                }).map(function(e, t) {
                    var n = ye(this).val();
        ...
        ye.extend({
            ...
            ajax: function(e, t) {
                function r(e, t, r, s) {
                    ...
                    w && (ye.lastModified[o] = w),
                    (w = C.getResponseHeader("etag")) && (ye.etag[o] = w)),
                ...
                e = void 0),
                t = t || {};
                var i, o, a, s, u, l, c, f, p, d, h = ye.ajaxSetup({}, t), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? ye(g) : ye.event, v = ye.Deferred(), y = ye.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                    readyState: 0,
                ...
                d = (Dt.test(o) ? "&" : "?") + "_=" + jt++ + d),
                h.url = o + d),
                h.ifModified && (ye.lastModified[o] && C.setRequestHeader("If-Modified-Since", ye.lastModified[o]),
                ye.etag[o] && C.setRequestHeader("If-None-Match", ye.etag[o])),
        ...
        ye.offset = {
            setOffset: function(e, t, n) {
                var r, i, o, a, s, u, l, c = ye.css(e, "position"), f = ye(e), p = {};
